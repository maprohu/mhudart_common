...
abstract class PdmLevel$Visitor$IData<R$, M, F, E> {
  R$ Function(PdMsgContainer<M, F, E> level) get level;
  R$ Function(PdRoot<M, F, E> top) get top;
  R$ Function(PdMsg<M, F, E> nested) get nested;
}
...
class PdmLevel$Visitor$Impl<R$, M, F, E> extends PdmLevel$Visitor<R$, M, F, E>
  ...
  R$ level(PdMsgContainer<M, F, E> level) => data$.level(level);
  R$ top(PdRoot<M, F, E> top) => data$.top(top);
  R$ nested(PdMsg<M, F, E> nested) => data$.nested(nested);
}
...
abstract class PdxBase$Visitor$IData<R$, M, F, E> {
  R$ Function() get base;
  R$ Function(PdFld<M, F, E> top) get top;
  R$ Function(PdOneof<M, F, E> oneof) get oneof;
}
...
class PdxBase$Visitor$Impl<R$, M, F, E> extends PdxBase$Visitor<R$, M, F, E>
  ...
  R$ base() => data$.base();
  R$ top(PdFld<M, F, E> top) => data$.top(top);
  R$ oneof(PdOneof<M, F, E> oneof) => data$.oneof(oneof);
}
...
abstract class PdRoot$IData<M, F, E> {
  M Function(PdMsg<M, F, E> msg) get msgPayload;
  F Function(PdFld<M, F, E> fld) get fldPayload;
  E Function(PdEnum<M, F, E> enm) get enumPayload;
...
class PdRoot$Impl<M, F, E> extends PdRoot<M, F, E>
  ...
  M msgPayload(PdMsg<M, F, E> msg) => data$.msgPayload(msg);
  F fldPayload(PdFld<M, F, E> fld) => data$.fldPayload(fld);
  E enumPayload(PdEnum<M, F, E> enm) => data$.enumPayload(enm);
